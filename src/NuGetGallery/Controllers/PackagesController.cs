...
namespace NuGetGallery
{
        ...
        : AppController
    {
        ...
        {
            string normalized = NuGetVersionExtensions.Normalize(version);
        ...
        public virtual async Task<ActionResult> VerifyPackage(VerifyPackageRequest formData)
        {
            ...
            using (Stream uploadFile = await _uploadFileService.GetUploadFileAsync(currentUser.Key))
            {
                ...
                var packageStreamMetadata = new PackageStreamMetadata
                {
                    ...
                    Hash = CryptographyService.GenerateHash(uploadFile.ReadAllBytes()),
        ...
        private async Task<PackageReader> SafeCreatePackage(NuGetGallery.User currentUser, Stream uploadFile)
        {
            ...
            PackageReader nugetPackage = null;
            try
            {
