...
#pragma warning restore 618
        ...
        private static void ValidateNuGetPackageMetadata(PackageMetadata packageMetadata)
        {
            ...
            foreach (var dependency in packageMetadata.GetDependencyGroups().SelectMany(s => s.Packages))
            {
            ...
            if (packageMetadata.GetDependencyGroups() != null && packageMetadata.GetDependencyGroups().Flatten().Length > Int16.MaxValue)
            {
